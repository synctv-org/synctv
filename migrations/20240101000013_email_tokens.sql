...
COMMENT ON TABLE email_tokens IS 'Generic email tokens for verification, password reset, login, and future flows';
COMMENT ON COLUMN email_tokens.token_type IS 'Application-defined numeric token type';
