...
use synctv_api_common::emby_thumbnail_urls::{
...
fn authorize_thumbnail_request(
    signing_key: &synctv_api_common::proxy_signature::ProxySigningKey,
...
mod tests {
    ...
    use synctv_api_common::proxy_signature::{ProxySigningKey, ProxySigningKeyQueryExt};
