...
async fn resource(
    ...
    stream_http_response::<NextcloudResourceResponse, _>(
        ...
        move |control| {
            ...
            async move {
                crate::impls::playback_provider::nextcloud::get_nextcloud_resource(
...
pub async fn get_nextcloud_subtitle(
    ...
    stream_http_response::<NextcloudSubtitleResponse, _>(
        ...
        move |control| {
            let state = stream_state;
            async move {
                crate::impls::playback_provider::nextcloud::get_nextcloud_subtitle(
                    deps(&state, Some(&control)),
                    req,
                )
                .await
...
) -> crate::impls::playback_provider::nextcloud::NextcloudPlaybackProviderDeps<'a> {
    crate::impls::playback_provider::nextcloud::NextcloudPlaybackProviderDeps {
