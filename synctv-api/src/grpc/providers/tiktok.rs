...
use synctv_proto::providers::tiktok::tik_tok_provider_service_server::TikTokProviderService;
use synctv_proto::providers::tiktok::{
    BindRequest, BindResponse, GetBindsRequest, GetBindsResponse, GetUserRequest, GetUserResponse,
...
use crate::impls::{EndpointRateLimitCategory, RequestExecutor, TikTokApiImpl};

#[derive(Clone)]
pub struct TikTokProviderGrpcService {
    api: Arc<TikTokApiImpl>,
    request_executor: Arc<RequestExecutor>,
    runtime_settings: Arc<crate::ApiRuntimeSettings>,
}

impl TikTokProviderGrpcService {
    #[must_use]
    pub fn new(
        ...
        Self {
            api: shared_api_runtime.tiktok_api.clone(),
            request_executor,
            runtime_settings,
        }
    }
...
impl TikTokProviderService for TikTokProviderGrpcService {
