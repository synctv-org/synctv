...
Run these commands from the production Compose file directory. If you do not have a deployment directory yet, first get `docker-compose.yml`, env examples, and the init script from [Docker Compose Deployment](../../deployment/docker-compose/#get-the-compose-files).
