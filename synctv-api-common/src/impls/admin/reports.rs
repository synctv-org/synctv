...
pub fn report_target_type_from_proto(
    value: i32,
...
pub fn report_scope_from_proto(
    value: i32,
...
pub fn report_status_from_proto(value: i32) -> Result<Option<ContentReportStatus>, ApiError> {
...
pub fn required_report_status_from_proto(value: i32) -> Result<ContentReportStatus, ApiError> {
