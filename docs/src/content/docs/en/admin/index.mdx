...
description: Manage users, rooms, permissions, Providers, and runtime settings.
---
...
- [Runtime Settings](./runtime-settings/): hot-update registration, RTMP, CORS, chat, and room policies.

The [CLI Reference](../reference/cli/) lists every flag. [Maintenance Tasks](../operations/maintenance/) and [Deployment and Runtime Boundaries](../operations/deployment-boundaries/) are part of the operations documentation.
