...
pub const IMAGE_ROUTE: &str = "/api/providers/synology/image";
...
pub enum SynologyImageAccessError {
    Invalid,
    WrongUser,
}
...
pub fn synology_file_image_url(
    server_id: &str,
...
pub fn sign_synology_image_url(
    image_url: &str,
...
pub fn verify_synology_image_access(
    signing_key: &ProxySigningKey,
    auth_user_id: &str,
    raw_query: &str,
    scope: SynologyImageScope<'_>,
