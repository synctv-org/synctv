...
pub struct PasskeyBindChallenge {
...
pub fn passkey_creation_options_to_proto(
...
pub fn passkey_request_options_to_proto(
...
pub fn passkey_registration_credential_from_proto(
...
pub fn passkey_authentication_credential_from_proto(
...
pub fn passkey_credential_to_proto(credential: &WebAuthnCredential) -> PasskeyCredential {
    PasskeyCredential {
...
impl ClientApiImpl {
    ...
    pub async fn start_passkey_bind_challenge(
        &self,
        user_id: &UserId,
        name: String,
