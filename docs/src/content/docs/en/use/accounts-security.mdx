...
| --- | --- | --- |
| Username and password | Username and password | Common local sign-in |
| OPAQUE password login | Local password | Password login without storing direct password-verifier equivalents |
...
Make sure you have at least two local verification methods: password, passkey/WebAuthn, or verified email. OAuth2 does not count as a local 2FA factor.
...
<Steps>
1. Complete the first factor: password, OPAQUE, passkey, email sign-in, or OAuth2.
2. If SyncTV asks for 2FA, choose one of the available second factors.
3. Complete email code, passkey, or password MFA.
