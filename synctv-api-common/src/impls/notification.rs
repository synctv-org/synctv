...
pub fn notification_type_to_proto(
...
pub fn notification_data_to_proto(
...
pub fn build_get_notification_request(req: &GetNotificationRequest) -> Result<i64, ApiError> {
    crate::impls::validate_proto_request(req)?;
    Ok(req.notification_id)
}

pub fn build_mark_as_read_request(req: &ProtoMarkAsReadRequest) -> Result<Vec<i64>, ApiError> {
    crate::impls::validate_proto_request(req)?;
    Ok(req.notification_ids.clone())
}

pub fn build_delete_notification_request(req: &DeleteNotificationRequest) -> Result<i64, ApiError> {
    crate::impls::validate_proto_request(req)?;
    Ok(req.notification_id)
}

pub fn notification_counts_to_proto(total: i64, unread_count: i64) -> Result<(i32, i32), ApiError> {
