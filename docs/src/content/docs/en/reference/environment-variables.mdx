...
| `SYNCTV_FILE_STORAGE_CHAT_IMAGES_BACKEND` | `file_storage.chat_images_backend` |
| `SYNCTV_FILE_STORAGE_USER_AVATARS_BACKEND` | `file_storage.user_avatars_backend` |
| `SYNCTV_FILE_STORAGE_VIDEO_COVERS_BACKEND` | `file_storage.video_covers_backend` |
...
SYNCTV_FILE_STORAGE_CHAT_IMAGES_BACKEND=database
SYNCTV_FILE_STORAGE_USER_AVATARS_BACKEND=database
SYNCTV_FILE_STORAGE_VIDEO_COVERS_BACKEND=database
...
SYNCTV_FILE_STORAGE_BACKENDS='{"database":{"type":"database","database":{"compression":"zstd"}}}'
```
...
SYNCTV_FILE_STORAGE_VIDEO_COVERS_BACKEND=s3_public
...
| `SYNCTV_GRPC_RATE_LIMITS_WEBSOCKET_MAX_REQUESTS` | `grpc_rate_limits.websocket_max_requests` |
| `SYNCTV_GRPC_RATE_LIMITS_WEBSOCKET_WINDOW_SECONDS` | `grpc_rate_limits.websocket_window_seconds` |
