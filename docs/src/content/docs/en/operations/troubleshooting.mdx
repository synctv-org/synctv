...
| Slow video startup or steadily increasing live-stream latency | Nginx is caching or buffering upstream responses | Disable `proxy_cache` and `proxy_buffering` as shown in [Nginx Reverse Proxy](../../install/nginx/) |
