...
#[must_use]
pub fn slice_cache_management_runtime_from_router_config(
...
pub fn slice_cache_stats_to_admin_proto(
    response: SliceCacheStatsResponse,
...
pub fn slice_cache_purge_to_admin_proto(
    response: SliceCachePurgeResponse,
...
pub fn slice_cache_evict_expired_to_admin_proto(
    response: SliceCacheEvictExpiredResponse,
...
fn slice_cache_purge_node_to_admin_proto(
    response: SliceCachePurgeNodeResult,
...
fn slice_cache_evict_expired_node_to_admin_proto(
    response: SliceCacheEvictExpiredNodeResult,
...
impl SliceCacheManagementRemoteClient for ApiSliceCacheManagementRemoteClient {
    async fn remote_stats(
        ...
        attach_slice_cache_cluster_secret(&mut request, &self.config.cluster.secret)?;
