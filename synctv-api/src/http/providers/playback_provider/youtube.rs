...
async fn youtube_resource(
    ...
    stream_http_response::<YoutubeResourceResponse, _>(
        ...
        move |request_control| {
            ...
            async move {
                crate::impls::playback_provider::youtube::get_youtube_resource(
...
async fn youtube_segment(
    ...
    stream_http_response::<YoutubeSegmentResponse, _>(
        ...
        move |request_control| {
            let state = state_for_stream;
            async move {
                crate::impls::playback_provider::youtube::get_youtube_segment(
                    youtube_deps(&state, Some(&request_control)),
                    req,
                )
                .await
...
async fn youtube_subtitle(
    ...
    stream_http_response::<YoutubeSubtitleResponse, _>(
        ...
        move |request_control| {
            let state = state_for_stream;
            async move {
                crate::impls::playback_provider::youtube::get_youtube_subtitle(
                    youtube_deps(&state, Some(&request_control)),
                    req,
                )
                .await
...
) -> crate::impls::playback_provider::youtube::YoutubePlaybackProviderDeps<'a> {
    crate::impls::playback_provider::youtube::YoutubePlaybackProviderDeps {
