...
Rooms are the daily entry point in SyncTV. Users watch, chat, send danmaku, and switch playlists in rooms. Room administrators manage members and permissions. Platform administrators maintain accounts, reviews, Providers, livestreaming, and runtime policy.
...
<CardGrid>
  <LinkCard
    title="Use SyncTV"
    href="use/"
    description="Sign in, join rooms, watch together, chat, add media, and manage personal settings."
  />
  <LinkCard
  ...
  <LinkCard
    ...
    description="Use OpenAPI, gRPC, WebSocket Realtime, tickets, playback snapshots, and errors."
  />
</CardGrid>
...
| Fix playback drift or failure | [Watch Together](use/watch-together/) and [User Troubleshooting](use/troubleshooting/) |
...
<CardGrid>
  <Card title="Rooms" icon="puzzle">
    Members, playlists, chat, danmaku, permissions, and current playback state are organized around rooms. See [Rooms](concepts/rooms/).
  </Card>
  <Card title="Watching Together" icon="youtube">
