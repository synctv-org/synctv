...
impl ClientApiImpl {
    ...
    pub async fn start_passkey_registration_challenge_with_control(
        &self,
        username: String,
        email: String,
        name: String,
    ...
    pub async fn finish_passkey_registration_with_credential_control(
        &self,
        session_id: &str,
    ...
    pub async fn finish_passkey_login_with_credential_control(
        &self,
        session_id: &str,
    ...
    pub async fn start_mfa_passkey_challenge_with_control(
        &self,
        mfa_session_id: &str,
    ) -> Result<PasskeyLoginChallenge, ApiError> {
        let user = self
    ...
    pub async fn finish_mfa_passkey_with_credential_control(
        &self,
        mfa_session_id: &str,
...
mod tests {
    ...
    fn opaque_registration_normalizes_empty_email_before_proto_validation() -> TestResult {
        let mut request = synctv_proto::client::StartOpaqueRegistrationRequest {
            ...
            registration_request: vec![1, 2, 3].into(),
        };
