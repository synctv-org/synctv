...
| Members | `room member add/kick/ban/unban/set-permissions` | Access and administration capability |
| Settings | `room settings update/reset` | Join rules, guests, chat, danmaku, and defaults |
...
| Remove disruptive member | Kick or ban member | Room ban is not a platform ban |
