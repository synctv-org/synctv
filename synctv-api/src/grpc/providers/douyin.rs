...
use synctv_proto::providers::douyin::douyin_provider_service_server::DouyinProviderService;
use synctv_proto::providers::douyin::{
    BindRequest, BindResponse, GetBindsRequest, GetBindsResponse, ListUserPostsRequest,
...
use crate::impls::{DouyinApiImpl, EndpointRateLimitCategory, RequestExecutor};

#[derive(Clone)]
pub struct DouyinProviderGrpcService {
    api: Arc<DouyinApiImpl>,
    request_executor: Arc<RequestExecutor>,
    runtime_settings: Arc<crate::ApiRuntimeSettings>,
}

impl DouyinProviderGrpcService {
    #[must_use]
    pub fn new(
        ...
        Self {
            api: shared_api_runtime.douyin_api.clone(),
            request_executor,
            runtime_settings,
        }
    }
...
impl DouyinProviderService for DouyinProviderGrpcService {
