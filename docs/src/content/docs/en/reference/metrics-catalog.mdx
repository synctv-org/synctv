...
| `synctv_cluster_events_published_total` | counter | `event_type` | Published cluster events |
| `synctv_cluster_events_dropped_total` | counter | `reason` | Dropped cluster events |
