...
Room management affects online users. Query current state first, then validate joining, playback, chat, and permissions from a normal member account. The [Resource Lifecycle](../../operations/resource-lifecycle/) page defines deletion, recovery windows, and room bans.
...
| Livestream | `room stream list`, `room stream publish-key` | Publish keys and live sessions |
