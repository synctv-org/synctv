...
- Removing an authentication method while 2FA is enabled must still leave at least two usable methods.
...
<CardGrid>
  ...
  <Card title="Email and OAuth2" icon="document">
    Configure email codes, SMTP, OAuth2 providers, and redirect scheme.
  </Card>
