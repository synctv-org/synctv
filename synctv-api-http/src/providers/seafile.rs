        ...
        .execute_user_endpoint(
            ...
            move |auth| async move {
                ...
                if signed || public_owner != public_user {
                    let room_id = synctv_api_common::seafile_thumbnail_urls::verify_seafile_thumbnail_access(
                        &state.shared_api_runtime.proxy_signing_key,
                        &public_user,
                        &raw_query,
                        synctv_api_common::seafile_thumbnail_urls::SeafileThumbnailScope {
                            server_id: &server_id,
                    ...
                    .map_err(|error| match error {
                        synctv_api_common::seafile_thumbnail_urls::SeafileThumbnailAccessError::Invalid => {
                            synctv_api_common::impls::ApiError::Authentication(
                                "Invalid Seafile thumbnail signature".to_string(),
                            )
                        }
                        synctv_api_common::seafile_thumbnail_urls::SeafileThumbnailAccessError::WrongUser => {
