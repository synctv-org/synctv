...
// ============================================================================
// Settings Registry Structure Tests
// ============================================================================
...
fn test_settings_registry_has_all_required_fields() {
    ...
    // Server settings
    #[allow(dead_code)]
    fn check_server_settings(_registry: &SettingsRegistry) {
        // These fields must exist
        // signup_enabled: Setting<bool>
        // allow_room_creation: Setting<bool>
        // max_rooms_per_user: Setting<i64>
        // max_members_per_room: Setting<i64>
        // max_chat_messages: Setting<u64>
    }

    // Permission settings
    #[allow(dead_code)]
    fn check_permission_settings(_registry: &SettingsRegistry) {
        // admin_default_permissions: Setting<u64>
        // member_default_permissions: Setting<u64>
        // guest_default_permissions: Setting<u64>
    }

    // Room settings
    #[allow(dead_code)]
    fn check_room_settings(_registry: &SettingsRegistry) {
        // disable_create_room: Setting<bool>
        // create_room_need_review: Setting<bool>
        // room_ttl: Setting<i64>
        // room_must_need_pwd: Setting<bool>
        // room_must_no_need_pwd: Setting<bool>
    }

    // User settings
    #[allow(dead_code)]
    fn check_user_settings(_registry: &SettingsRegistry) {
        // signup_need_review: Setting<bool>
        // enable_password_signup: Setting<bool>
        // password_signup_need_review: Setting<bool>
        // enable_guest: Setting<bool>
    }

    // Proxy settings
    #[allow(dead_code)]
    fn check_proxy_settings(_registry: &SettingsRegistry) {
        // movie_proxy: Setting<bool>
        // live_proxy: Setting<bool>
        // allow_proxy_to_local: Setting<bool>
        // proxy_cache_enable: Setting<bool>
    }

    // RTMP settings
    #[allow(dead_code)]
    fn check_rtmp_settings(_registry: &SettingsRegistry) {
        // custom_publish_host: Setting<String>
        // ts_disguised_as_png: Setting<bool>
    }

    // Email settings
    #[allow(dead_code)]
    fn check_email_settings(_registry: &SettingsRegistry) {
        // email_whitelist_enabled: Setting<bool>
        // email_whitelist: Setting<String>
    }

    // WebRTC settings
    #[allow(dead_code)]
    fn check_webrtc_settings(_registry: &SettingsRegistry) {
        // external_stun_servers: Setting<StunServerList>
        // turn_servers: Setting<TurnServerList>
    }

    // Chat settings
    #[allow(dead_code)]
    fn check_chat_settings(_registry: &SettingsRegistry) {
        // max_chat_messages_per_room: Setting<u64>
    }

    // CORS settings
    #[allow(dead_code)]
    fn check_cors_settings(_registry: &SettingsRegistry) {
        // cors_allowed_origins: Setting<CorsAllowedOrigins>
    }

    // If this compiles, all required fields exist
    let _ = (
