...
SyncTV spans self-hosting, media proxying, realtime collaboration, authentication security, and multi-node deployment. Use this page as a vocabulary map before going deep into configuration and operations.

## Core Terms

| Term | Short definition | Where you see it |
| --- | --- | --- |
...
| fail-closed | Rejecting a business request when a critical dependency or event write fails, avoiding split database/cache state | write operations, cluster events, transactional outbox |
