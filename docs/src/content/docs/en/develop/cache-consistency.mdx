...
| [Kubernetes API concepts](https://kubernetes.io/docs/reference/using-api/api-concepts/) | `resourceVersion` is used for change detection and consistency requirements | `RoomSettings.version`, `Playback.version`, and `RoomMember.version` should be cache source versions |
