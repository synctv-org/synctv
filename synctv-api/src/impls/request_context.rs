...
impl EndpointRateLimitScope {
    ...
    pub const fn key_suffix(self) -> &'static str {
        match self {
            ...
            Self::RoomReportsCreate => "room_reports_create",
            Self::RoomReportsRead => "room_reports_read",
            Self::RoomReportsWrite => "room_reports_write",
            Self::RoomMedia => "room_media",
            Self::RoomCover => "room_cover",
            Self::PlaylistCover => "playlist_cover",
            Self::MediaCover => "media_cover",
            Self::MediaThumbnail => "media_thumbnail",
            ...
            Self::ManageRooms => "managed_rooms",
