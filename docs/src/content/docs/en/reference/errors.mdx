...
| `ServerMessage.resource_observe_error` | Invalid observe id, too many observations, or resource load failure |
...
<CardGrid>
  ...
  <Card title="Keep request IDs" icon="magnifier">
    Collect `request_id`, time, path, and status for support.
  </Card>
