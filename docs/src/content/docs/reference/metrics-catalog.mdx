...
| `synctv_cluster_events_published_total` | counter | `event_type` | 已发布集群事件 |
| `synctv_cluster_events_dropped_total` | counter | `reason` | 被丢弃的集群事件 |
...
- [Metrics 监控](../../configuration/metrics/)
