...
Users have global roles, effective state, and security preferences. When handling user issues, first decide whether the cause is account state, authentication method, global role, or room permissions. The [Resource Lifecycle](../../operations/resource-lifecycle/) page defines deletion, recovery, and resource cascades.
