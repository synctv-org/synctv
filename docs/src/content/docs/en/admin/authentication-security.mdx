...
For Provider credentials, direct/proxy selection, and playback snapshot details, see [Add Media](../../use/media-sources/) and [Playback and Proxy Model](../../use/playback-and-proxy/).
