        ...
        .execute_user_endpoint(
            ...
            move |authenticated| async move {
                ...
                if has_signature || public_owner_id != public_auth_user_id {
                    let room_id = crate::fnos_thumbnail_urls::verify_fnos_thumbnail_access(
                    ...
                    .map_err(|error| match error {
                        crate::fnos_thumbnail_urls::FnosThumbnailAccessError::Invalid => {
                            crate::impls::ApiError::Authentication(
                                "Invalid FNOS thumbnail signature".to_string(),
                            )
                        }
                        crate::fnos_thumbnail_urls::FnosThumbnailAccessError::WrongUser => {
