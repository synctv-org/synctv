...
pub const THUMBNAIL_ROUTE: &str = "/api/providers/seafile/thumbnail";
...
pub enum SeafileThumbnailAccessError {
    Invalid,
    WrongUser,
}
...
pub fn sign_seafile_thumbnail_url(
    url: &str,
    room_id: &str,
    user_id: &str,
...
pub fn verify_seafile_thumbnail_access(
    signing_key: &ProxySigningKey,
    auth_user_id: &str,
    raw_query: &str,
