...
use synctv_proto::providers::seafile::{
    GetBindsRequest, GetBindsResponse, GetThumbnailRequest, ListRepositoriesRequest, ListRequest,
    ListResponse, ListStarredRequest, LoginRequest, LoginResponse, LogoutRequest, LogoutResponse,
