...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    add_field_attributes(
        ...
        &[
            ...
            ".synctv.client.SearchChatMessagesRequest.query",
            ".synctv.client.SearchChatMessagesRequest.cursor",
            ".synctv.client.SearchChatMessagesRequest.limit",
            ".synctv.client.SearchChatMessagesRequest.include_deleted",
            ".synctv.client.SearchChatMessagesRequest.user_id",
