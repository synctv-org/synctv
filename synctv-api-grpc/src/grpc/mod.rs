...
//
// Keep business behavior in synctv-api-common/src/impls and synctv-core. gRPC code
...
async fn set_registered_grpc_services_with_status(
    ...
    if state.provider_services_registered {
        ...
        set_service_status!(
            ...
            DirectUrlPlaybackProviderServiceServer<
                crate::providers::playback_provider::direct_url::DirectUrlPlaybackProviderGrpcService,
            >
        );
        set_service_status!(
            health_reporter,
            ...
            AlistPlaybackProviderServiceServer<
                crate::providers::playback_provider::alist::AlistPlaybackProviderGrpcService,
            >
        );
        set_service_status!(
            health_reporter,
            ...
            EmbyPlaybackProviderServiceServer<
                crate::providers::playback_provider::emby::EmbyPlaybackProviderGrpcService,
            >
        );
        set_service_status!(
            health_reporter,
            ...
            BilibiliPlaybackProviderServiceServer<
                crate::providers::playback_provider::bilibili::BilibiliPlaybackProviderGrpcService,
            >
        );
        set_service_status!(
            health_reporter,
            ...
            RtmpPlaybackProviderServiceServer<
                crate::providers::playback_provider::rtmp::RtmpPlaybackProviderGrpcService,
            >
        );
        set_service_status!(
            health_reporter,
            ...
            LiveProxyPlaybackProviderServiceServer<
                crate::providers::playback_provider::live_proxy::LiveProxyPlaybackProviderGrpcService,
            >
        );
        set_service_status!(
            health_reporter,
            ...
            TwitchPlaybackProviderServiceServer<
                crate::providers::playback_provider::twitch::TwitchPlaybackProviderGrpcService,
            >
        );
        set_service_status!(
            health_reporter,
            ...
            YoutubePlaybackProviderServiceServer<
                crate::providers::playback_provider::youtube::YoutubePlaybackProviderGrpcService,
            >
        );
        set_service_status!(
            health_reporter,
            ...
            HuyaPlaybackProviderServiceServer<
                crate::providers::playback_provider::huya::HuyaPlaybackProviderGrpcService,
            >
        );
        set_service_status!(
            health_reporter,
            ...
            DouyuPlaybackProviderServiceServer<
                crate::providers::playback_provider::douyu::DouyuPlaybackProviderGrpcService,
            >
        );
        set_service_status!(
            health_reporter,
            ...
            DouyinPlaybackProviderServiceServer<
                crate::providers::playback_provider::douyin::DouyinPlaybackProviderGrpcService,
            >
        );
        set_service_status!(
            health_reporter,
            ...
            TikTokPlaybackProviderServiceServer<
                crate::providers::playback_provider::tiktok::TikTokPlaybackProviderGrpcService,
            >
        );
        set_service_status!(
            health_reporter,
            ...
            AcFunPlaybackProviderServiceServer<
                crate::providers::playback_provider::acfun::AcFunPlaybackProviderGrpcService,
            >
        );
        set_service_status!(
            health_reporter,
            ...
            CctvPlaybackProviderServiceServer<
                crate::providers::playback_provider::cctv::CctvPlaybackProviderGrpcService,
            >
        );
        set_service_status!(
            health_reporter,
            ...
            FnosPlaybackProviderServiceServer<
                crate::providers::playback_provider::fnos::FnosPlaybackProviderGrpcService,
            >
        );
        set_service_status!(
            health_reporter,
            ...
            QnapPlaybackProviderServiceServer<
                crate::providers::playback_provider::qnap::QnapPlaybackProviderGrpcService,
            >
        );
        set_service_status!(
            health_reporter,
        ...
        set_service_status!(
            ...
            SeafilePlaybackProviderServiceServer<
                crate::providers::playback_provider::seafile::SeafilePlaybackProviderGrpcService,
            >
        );
        set_service_status!(
            health_reporter,
            ...
            SynologyPlaybackProviderServiceServer<
                crate::providers::playback_provider::synology::SynologyPlaybackProviderGrpcService,
            >
        );
    }
    ...
    set_service_status!(
        ...
        synctv_cluster::grpc::ServerStateServiceServer<
            synctv_api_common::status::ServerStateGrpcService,
        >
    );
    set_service_status!(
        health_reporter,
...
pub struct GrpcServerOptions<'a> {
    pub runtime_settings: &'a synctv_api_common::ApiRuntimeSettings,
    ...
    pub request_executor: Arc<synctv_api_common::impls::RequestExecutor>,
    pub metrics_access_controller: Arc<synctv_api_common::metrics_auth::MetricsAccessController>,
    pub client_api: Arc<synctv_api_common::impls::ClientApiImpl>,
    pub admin_api: Option<Arc<synctv_api_common::impls::AdminApiImpl>>,
    pub email_api: Option<Arc<synctv_api_common::impls::EmailApiImpl>>,
    pub notification_api: Option<Arc<synctv_api_common::impls::NotificationApiImpl>>,
    pub oauth2_api: Option<Arc<synctv_api_common::impls::OAuth2ApiImpl>>,
    ...
    pub provider_common_api: Arc<synctv_api_common::providers::ProviderCommonApiImpl>,
    pub bilibili_api: Arc<synctv_api_common::providers::BilibiliApiImpl>,
    pub alist_api: Arc<synctv_api_common::providers::AlistApiImpl>,
    pub emby_api: Arc<synctv_api_common::providers::EmbyApiImpl>,
    pub cloudreve_api: Arc<synctv_api_common::providers::CloudreveApiImpl>,
    pub twitch_api: Arc<synctv_api_common::providers::TwitchApiImpl>,
    pub youtube_api: Arc<synctv_api_common::providers::YoutubeApiImpl>,
    pub douyin_api: Arc<synctv_api_common::providers::DouyinApiImpl>,
    pub tiktok_api: Arc<synctv_api_common::providers::TikTokApiImpl>,
    pub fnos_api: Arc<synctv_api_common::providers::FnosApiImpl>,
    pub qnap_api: Arc<synctv_api_common::providers::QnapApiImpl>,
    pub synology_api: Arc<synctv_api_common::providers::SynologyApiImpl>,
    pub nextcloud_api: Arc<synctv_api_common::providers::NextcloudApiImpl>,
    pub seafile_api: Arc<synctv_api_common::providers::SeafileApiImpl>,
    pub truenas_api: Arc<synctv_api_common::providers::TrueNasApiImpl>,
    ...
    pub shared_http_app_state: Option<Arc<synctv_api_common::AppState>>,
...
struct FallbackHttpAppStateDeps {
    ...
    metrics_access_controller: Arc<synctv_api_common::metrics_auth::MetricsAccessController>,
    client_api: Arc<synctv_api_common::impls::ClientApiImpl>,
    admin_api: Option<Arc<synctv_api_common::impls::AdminApiImpl>>,
    email_api: Option<Arc<synctv_api_common::impls::EmailApiImpl>>,
    notification_api: Option<Arc<synctv_api_common::impls::NotificationApiImpl>>,
    oauth2_api: Option<Arc<synctv_api_common::impls::OAuth2ApiImpl>>,
    ...
    provider_common_api: Arc<synctv_api_common::providers::ProviderCommonApiImpl>,
    bilibili_api: Arc<synctv_api_common::providers::BilibiliApiImpl>,
    alist_api: Arc<synctv_api_common::providers::AlistApiImpl>,
    emby_api: Arc<synctv_api_common::providers::EmbyApiImpl>,
    tiktok_api: Arc<synctv_api_common::providers::TikTokApiImpl>,
    cloudreve_api: Arc<synctv_api_common::providers::CloudreveApiImpl>,
    twitch_api: Arc<synctv_api_common::providers::TwitchApiImpl>,
    youtube_api: Arc<synctv_api_common::providers::YoutubeApiImpl>,
    douyin_api: Arc<synctv_api_common::providers::DouyinApiImpl>,
    fnos_api: Arc<synctv_api_common::providers::FnosApiImpl>,
    qnap_api: Arc<synctv_api_common::providers::QnapApiImpl>,
    synology_api: Arc<synctv_api_common::providers::SynologyApiImpl>,
    nextcloud_api: Arc<synctv_api_common::providers::NextcloudApiImpl>,
    seafile_api: Arc<synctv_api_common::providers::SeafileApiImpl>,
    truenas_api: Arc<synctv_api_common::providers::TrueNasApiImpl>,
...
async fn build_axum_router_with_health(
    ...
    let playback_provider_state = Arc::new(
        crate::providers::playback_provider::PlaybackProviderGrpcState {
            ...
            live_streaming_infrastructure: shared_http_app_state
                .live_streaming_infrastructure
                .clone(),
...
mod tests {
    ...
    use synctv_api_common::impls::{
        client::RoomActor, AdminApiImpl, AdminApiOptions, AdminApiRuntime, ClientApiImpl,
        ClientApiOptions, ClientApiRuntime, ClientApiRuntimeServices, RequestExecutor,
    };
    use synctv_api_common::providers::{
    ...
    fn make_chat_watch_client_api(
        ...
        let request_executor = Arc::new(RequestExecutor::new(
            Arc::new(synctv_api_common::ApiRuntimeSettings::default()),
        ...
        Ok(ClientApiImpl::new_with_runtime(
            synctv_api_common::impls::ClientApiOptions {
                ...
                runtime_settings: Arc::new(synctv_api_common::ApiRuntimeSettings::default()),
            ...
            synctv_api_common::impls::ClientApiRuntime {
                realtime_event_service: event_service.clone(),
                chat_event_dispatcher:
                    synctv_api_common::chat_event_dispatcher::default_chat_event_dispatcher(
                        event_service,
                    ),
                jwt_validator: request_executor.jwt_validator().clone(),
                request_executor,
                ..synctv_api_common::test_support::client_api_runtime()
            },
        ))
    }
    ...
    fn test_map_api_error_timeout_maps_to_deadline_exceeded() {
        let status = map_api_error(synctv_api_common::impls::ApiError::Timeout(
    ...
    async fn test_build_fallback_http_app_state_reuses_shared_runtime_instances() -> TestResult {
        ...
        let event_service: Arc<dyn RealtimeEventService> = Arc::new(
            synctv_api_common::test_support::RecordingRealtimeEventService::with_node(
                "fallback-http-node",
                true,
            ),
        );
        ...
        let proxy_slice_cache_config =
            synctv_api_common::runtime_adapters::proxy_slice_cache_options_from_runtime_settings(
        ...
        let twitch_api = Arc::new(synctv_api_common::providers::TwitchApiImpl::new(
            credential_backed_providers.twitch.clone(),
            event_service.clone(),
        ));
        let youtube_api = Arc::new(synctv_api_common::providers::YoutubeApiImpl::new(
            credential_backed_providers.youtube.clone(),
            event_service.clone(),
        ));
        let douyin_api = Arc::new(synctv_api_common::providers::DouyinApiImpl::new(
            credential_backed_providers.douyin.clone(),
            event_service.clone(),
        ));
        let tiktok_api = Arc::new(synctv_api_common::providers::TikTokApiImpl::new(
            credential_backed_providers.tiktok.clone(),
            event_service.clone(),
        ));
        let fnos_api = Arc::new(synctv_api_common::providers::FnosApiImpl::new(
            credential_backed_providers.fnos.clone(),
            event_service.clone(),
        ));
        let qnap_api = Arc::new(synctv_api_common::providers::QnapApiImpl::new(
            credential_backed_providers.qnap.clone(),
            event_service.clone(),
        ));
        let synology_api = Arc::new(synctv_api_common::providers::SynologyApiImpl::new(
            credential_backed_providers.synology.clone(),
            event_service.clone(),
        ));
        let nextcloud_api = Arc::new(synctv_api_common::providers::NextcloudApiImpl::new(
            credential_backed_providers.nextcloud.clone(),
            event_service.clone(),
        ));
        let seafile_api = Arc::new(synctv_api_common::providers::SeafileApiImpl::new(
            credential_backed_providers.seafile.clone(),
            event_service.clone(),
        ));
        let truenas_api = Arc::new(synctv_api_common::providers::TrueNasApiImpl::new(
    ...
    fn test_cluster_grpc_service_requires_cluster_mode() {
        let mut runtime_settings = synctv_api_common::ApiRuntimeSettings::default();
