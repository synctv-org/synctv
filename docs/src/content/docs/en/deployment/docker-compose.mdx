...
## Use Production Compose By Default
...
If you have not chosen a deployment model yet, start with [Choose a Deployment Path](../choose-path/). For long-running service without Kubernetes, production Compose is usually the right answer.
