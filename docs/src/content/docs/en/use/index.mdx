...
<CardGrid>
  ...
  <LinkCard title="Chat and Danmaku" href="./chat-danmaku/" description="Use room chat and danmaku, and understand mute, disabled chat, and Realtime issues." />
...
| Chat and danmaku | Room sidebar and player overlay | Cannot send, messages not syncing, danmaku disabled |
