...
description: General configuration model for Alist, Emby-compatible servers, Bilibili, and other media providers.
---
...
- Alist.
- Emby-compatible servers (Emby/Jellyfin), exposed through provider type `emby`.
- Bilibili.
