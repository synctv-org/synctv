...
#[cfg_attr(
    ...
    utoipa::path(
        get,
        path = "/api/playback-providers/{roomId}/huya/{version}/resources/{modeName}/{mediaIndex}",
...
#[cfg_attr(
    ...
    utoipa::path(
        get,
        path = "/api/playback-providers/{roomId}/huya/{version}/segments",
        tag = "Huya Playback Provider",
        params(
            ("roomId" = String, Path),
...
#[cfg_attr(
    ...
    utoipa::path(
        get,
        path = "/api/playback-providers/{roomId}/huya/{version}/danmakus/{modeName}/{mediaIndex}",
        tag = "Huya Playback Provider",
        params(
            ("roomId" = String, Path),
            ("version" = String, Path), ("modeName" = String, Path),
