...
如果你要理解管理动作的业务语义，先看 [管理员操作手册](../../guides/administration/)。如果你要修改房间角色、权限位、房间设置或用户偏好，先看 [房间、权限与用户偏好](../../guides/rooms-permissions/)。
...
```bash
synctv room create "电影房" --actor-user alice
synctv room list
...
synctv playlist create <ROOM_ID> --title "周末片单"
synctv playlist update <ROOM_ID> <PLAYLIST_ID> --title "新标题"
...
synctv media add <ROOM_ID> --title "视频" --url "https://example.com/video.mp4"
synctv media edit <ROOM_ID> <MEDIA_ID> --title "新标题"
