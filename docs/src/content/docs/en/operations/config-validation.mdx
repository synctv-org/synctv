...
First make sure you got the production Compose files from [Docker Compose Deployment](../../deployment/docker-compose/#get-the-compose-files), then generated `.env.postgres` and `.env.synctv` in the same directory.
