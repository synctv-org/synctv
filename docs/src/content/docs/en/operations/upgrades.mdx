...
8. If protocol or protobuf behavior changes, confirm [API and Protobuf Evolution](../../reference/api-versioning/) and client examples are updated.
9. For Helm, run `helm lint` and `helm template`.
10. For Compose, run `make compose-config`.
</Steps>
