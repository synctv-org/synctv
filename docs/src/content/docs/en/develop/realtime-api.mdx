...
| --- | --- | --- |
| `Authorization: Bearer <access_token>` | Native clients, CLI, server-side SDKs | Token does not enter the URL |
...
| WebRTC signaling | offer, answer, and ICE candidates need room-scoped forwarding |
