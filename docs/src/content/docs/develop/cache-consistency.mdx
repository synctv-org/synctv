...
| [Kubernetes API concepts](https://kubernetes.io/docs/reference/using-api/api-concepts/) | `resourceVersion` 同时用于变更检测和一致性要求 | `RoomSettings.version`、`Playback.version`、`RoomMember.version` 应作为缓存源版本 |
