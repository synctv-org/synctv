...
6. Compare against the [Configuration Index](../../reference/configuration-index/) and [Full Configuration Example](../../configuration/full-example/).
...
Run these commands from the production Compose file directory. If you do not have a deployment directory yet, first get `docker-compose.yml`, env examples, and the init script from [Docker Compose Deployment](../../deployment/docker-compose/#get-production-compose-files).
...
<Tabs syncKey="helm-upgrade">
  <TabItem label="Render Check" icon="seti:kubernetes">
