...
pub fn parse_proto_chat_attachments(
...
pub fn parse_optional_room_category_id(
    value: &str,
    public_id_codec: &synctv_adapter::PublicIdCodec,
...
pub fn chat_message_selection_from_proto(
...
pub fn build_search_chat_messages_query(
    room_id: synctv_core::models::RoomId,
