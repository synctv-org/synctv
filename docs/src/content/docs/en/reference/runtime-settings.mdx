...
| `permissions.guest_default` | Permission-name array | Built-in guest permission set | Global default permissions for room guest |
...
See [Rooms, Permissions, and Preferences](../../guides/rooms-permissions/) for permission names, role defaults, and room override rules.
