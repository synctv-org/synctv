...
SyncTV is in a new-project phase. Its own protobuf, HTTP fields, and Realtime messages can still be cleaned up without draft backward compatibility. Third-party vendored proto is outside this policy and should not be edited casually.
