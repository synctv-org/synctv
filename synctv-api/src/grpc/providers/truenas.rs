...
use synctv_proto::providers::truenas::true_nas_provider_service_server::TrueNasProviderService;
use synctv_proto::providers::truenas::{
    GetBindsRequest, GetBindsResponse, ListRequest, ListResponse, LoginRequest, LoginResponse,
    LogoutRequest, LogoutResponse,
};
use tonic::{Request, Response, Status};

use crate::api_runtime::SharedApiRuntime;
use crate::impls::{EndpointRateLimitCategory, RequestExecutor, TrueNasApiImpl};

#[derive(Clone)]
pub struct TrueNasProviderGrpcService {
    api: Arc<TrueNasApiImpl>,
    request_executor: Arc<RequestExecutor>,
    runtime_settings: Arc<crate::ApiRuntimeSettings>,
}

impl TrueNasProviderGrpcService {
    #[must_use]
    pub fn new(
...
impl TrueNasProviderService for TrueNasProviderGrpcService {
    async fn login(
        &self,
