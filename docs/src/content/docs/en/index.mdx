...
<nav class="docs-home-actions" aria-label="Installation paths">
  <a href="install/docker-compose/"><Icon name="rocket" />Install with Docker Compose</a>
  <a href="install/choose-path/"><Icon name="list-format" />Choose a deployment</a>
  <a href="install/downloads/"><Icon name="download" />Client downloads</a>
</nav>
...
<div class="docs-directory">
  <section>
    ...
    <ul class="docs-link-list">
      <li><a href="install/docker-compose/"><strong>Install with Docker Compose</strong><span>Server, NAS, or virtual machine</span></a></li>
      ...
      <li><a href="install/downloads/"><strong>Client downloads</strong><span>Android, iOS, macOS, Windows, and Linux</span></a></li>
    </ul>
  </section>
  ...
  <section>
    <div class="docs-directory-heading"><Icon name="laptop" /><h2>Administer</h2></div>
    <ul class="docs-link-list">
      <li><a href="admin/"><strong>Administer SyncTV</strong><span>Users, rooms, permissions, and Providers</span></a></li>
      <li><a href="admin/users/"><strong>Manage users</strong><span>Roles, bans, and account security status</span></a></li>
      <li><a href="admin/rooms-members/"><strong>Rooms and members</strong><span>Room lifecycle, member roles, and playback control</span></a></li>
      <li><a href="admin/runtime-settings/"><strong>Runtime settings</strong><span>Inspect and change database-backed settings</span></a></li>
    </ul>
  </section>

  <section>
    <div class="docs-directory-heading"><Icon name="laptop" /><h2>Operate</h2></div>
    <ul class="docs-link-list">
      <li><a href="operations/upgrades/"><strong>Upgrade and migrate</strong><span>Backups, database migrations, and rollback</span></a></li>
  ...
  <section>
    <div class="docs-directory-heading"><Icon name="puzzle" /><h2>API and reference</h2></div>
    <ul class="docs-link-list">
      <li><a href="integrations/client-integration/"><strong>Client integration</strong><span>Authentication, HTTP, gRPC, and Realtime</span></a></li>
      ...
      <li><a href="reference/environment-variables/"><strong>Environment variables</strong><span>Container and service configuration overrides</span></a></li>
    </ul>
  </section>
</div>
