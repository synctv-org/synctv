...
pub fn pagination_limit_offset_i64(
    page: i32,
    page_size: i32,
    label: &'static str,
...
pub fn proto_review_status_filter(
    value: i32,
...
pub fn proto_user_status_filter(value: i32) -> Result<Option<UserStatus>, ApiError> {
...
pub fn proto_user_role_filter(value: i32) -> Result<Option<UserRole>, ApiError> {
...
pub fn ban_record_target_type_from_proto(
    value: i32,
...
pub fn proto_admin_sort_direction(
    sort_direction: i32,
...
pub fn proto_admin_user_list_sort_by(
    sort_by: i32,
...
pub fn proto_admin_active_stream_list_sort_by(
    sort_by: i32,
...
pub fn proto_admin_active_stream_sort_direction(
    sort_direction: i32,
) -> Result<CoreSortDirection, ApiError> {
    match synctv_proto::admin::SortDirection::try_from(sort_direction)
        .map_err(|_| ApiError::InvalidInput("Unsupported sort direction".to_string()))?
